...
SECRET_KEY = 'django-insecure-+z2o_&shk(n_#-4p)0(pd3w-x--vmcd9gl)wb2tf8z^_-k2-f'
...
MODELTRANSLATION_FALLBACK_LANGUAGES = {'default':('en', 'ru'), 'uz':('ru', )}
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Quyosh paneli",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Quyosh paneli",
    ...
    "welcome_sign": "Welcome to the ITM admin",
